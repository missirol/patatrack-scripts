...
def multiCmsRun(
  ...
  # GPU0 is closest to NUMA nodes 0-3, GPU1 is closest to NUMA nodes 4-7
  gpu_assignment =  list(itertools.islice(itertools.cycle([ 'GPU-d913526b-e251-ab70-e4a1-385dc9c19e9e' ] * 4 + [ 'GPU-983b4a19-980c-bfbb-19ba-ab2ad93f197e' ] * 4), jobs))
